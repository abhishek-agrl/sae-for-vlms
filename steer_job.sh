...
#SBATCH --job-name=sae_steer                          # A nice readable name of your job, to see it in the queue
#SBATCH --partition=ampere
#SBATCH --nodes=1                                     # Number of nodes to request
#SBATCH --cpus-per-task=2                             # Number of CPUs to request
#SBATCH --time=48:00:00
#SBATCH --output=logs/result_%j.out
##SBATCH --array=1-6                                   # Launches 3 identical jobs indexed 0, 1, 2
#SBATCH --gres=gpu:1
...
python3 run_steering_experiment.py --mode standard --utk_image_dir /home/abhishek.agrawal/utkface_split/test/ --sae_paths batch_topk_sae_17=layer_17/BatchTopKSAE_patch_layer_17_1e5_24/trainer_0/ae.pt --sae_type batch_topk --interventions batch_topk_sae_17:39278:-40 --output_csv results_steered.csv
echo "Done"